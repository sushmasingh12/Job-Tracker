    ...
    <header className="h-16 bg-neutral-surface border-b border-neutral-border sticky top-0 z-30 px-6 flex items-center justify-between shrink-0">
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          className="bg-primary hover:bg-primary-dark text-white font-medium py-2 px-4 rounded-lg shadow-md shadow-primary/20 transition-all active:scale-95 flex items-center gap-2 text-sm"
        >

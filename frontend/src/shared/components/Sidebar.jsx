...
import { selectCurrentUser, logout } from "../../features/auth/store/authSlice";
    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto py-6 px-3 space-y-1">
          ...
          <NavLink to="/resume" onClick={close} className={navClass}>
            <span className="material-symbols-outlined">description</span>
            Resume Builder
          </NavLink>

          <NavLink to="/cover-letter" onClick={close} className={navClass}>
            <span className="material-symbols-outlined">auto_fix_high</span>
            Cover Letter
          </NavLink>

          <NavLink to="/interview-prep" onClick={close} className={navClass}>

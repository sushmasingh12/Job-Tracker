...
function ApplicationRow({ title, company, location, status, date, icon, onClick }) {
  ...
  return (
    <div
      ...
      role="button"
      tabIndex="0"
      className="bg-neutral-surface border border-neutral-border rounded-xl p-4 flex items-center gap-4 hover:border-primary/30 transition-colors shadow-sm cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-primary/20"
    >
      {/* Company icon */}

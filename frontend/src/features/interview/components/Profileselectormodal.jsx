...
const ProfileCard = ({ profile, isSelected, onSelect }) => {
  ...
  return (
    <button
      ...
      className={`w-full text-left p-3 sm:p-4 rounded-xl border transition-all group ${isSelected
    ...
    >
      <div className="flex items-start gap-2.5 sm:gap-3">
        {/* Company icon */}
        <div
          className={`w-9 h-9 sm:w-10 sm:h-10 rounded-lg flex items-center justify-center shrink-0 border ${isSelected
              ? 'bg-primary/10 border-primary/20'
              : 'bg-neutral-100 border-neutral-border'
            }`}
        >
          <span
            className={`material-symbols-outlined text-lg sm:text-xl ${isSelected ? 'text-primary' : 'text-neutral-muted'
              }`}
          >
            business
          </span>
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-2">
            <div className="min-w-0">
              <p className="font-semibold text-neutral-text text-xs sm:text-sm truncate">
                {profile.jobTitle}
              </p>
...
const ProfileSelectorModal = ({
  ...
  return (
    ...
    >
      <div className="bg-white rounded-t-2xl sm:rounded-2xl shadow-xl w-full sm:max-w-lg max-h-[90vh] sm:max-h-[80vh] flex flex-col border-t sm:border border-neutral-border">
        {/* Header */}
        <div className="flex items-center justify-between p-4 sm:p-6 border-b border-neutral-border shrink-0">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div>
              <h2 className="text-base sm:text-lg font-bold text-neutral-text leading-tight">
                Select Job Profile
              </h2>
        ...
        {/* Search */}
        <div className="p-3 sm:p-4 border-b border-neutral-border shrink-0">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 sm:py-2.5 border border-neutral-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary bg-neutral-50"
              autoFocus
            />
          </div>
        </div>
        ...
        {/* Footer */}
        <div className="p-3 sm:p-4 border-t border-neutral-border bg-neutral-50 rounded-b-2xl shrink-0">

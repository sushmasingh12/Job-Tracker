...
const menuItems = [
  ...
  { id: 'resume', label: 'Resume Settings', icon: 'fa-solid fa-file-lines' },
  { id: 'preferences', label: 'Application Preferences', icon: 'fa-solid fa-briefcase' },
  { id: 'notifications', label: 'Notification Settings', icon: 'fa-solid fa-bell' },
  { id: 'ai', label: 'AI/ATS Optimization', icon: 'fa-solid fa-microchip' },
  { id: 'appearance', label: 'Appearance Settings', icon: 'fa-solid fa-palette' },
...
const SettingsSidebar = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <div className="w-full lg:w-72 bg-white dark:bg-neutral-800 rounded-2xl shadow-sm border border-neutral-border dark:border-neutral-700 overflow-hidden">
      ...
      <nav className="p-2">
        {menuItems.map((item) => {
          ...
          return (
            ...
            >
              <i className={`${item.icon} w-5 h-5 transition-colors text-lg ${isActive ? 'text-primary' : 'text-neutral-muted group-hover:text-neutral-text'}`} />
      ...
      <div className="p-4 border-t border-neutral-border dark:border-neutral-700">
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl transition-all duration-200 text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 font-semibold"
        >

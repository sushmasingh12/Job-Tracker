        ...
        <section className="bg-neutral-surface rounded-2xl border border-neutral-border p-8 shadow-sm space-y-8">
          <div>
            ...
            <p className="text-neutral-muted text-sm leading-relaxed">
              Tailor your experience for specific job descriptions using
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="space-y-3">
                ...
                <div className="relative group">
                  <select className="w-full rounded-xl border-neutral-border bg-white text-sm focus:border-primary focus:ring-4 focus:ring-primary/10 appearance-none py-3 px-4 transition-all">
                    <option value="1">
                      Senior UI/UX Designer - Tech Innovators Inc.
                    </option>
                    <option value="2">
                      Product Design Lead - Fintech Solutions
                    </option>
                    <option value="3">
                      Frontend Specialist - Global Scale
                    </option>
                  </select>
              ...
              <div className="space-y-3">
                ...
                <div className="border-2 border-dashed border-neutral-border rounded-2xl p-6 flex flex-col items-center justify-center text-center hover:border-primary hover:bg-primary-light/30 transition-all cursor-pointer group bg-slate-50/50">
                  ...
                  <p className="text-xs text-neutral-muted mt-1 font-medium italic">
                    PDF or DOCX (max 5MB)
                  </p>
                </div>
            ...
            <div className="space-y-3">
              ...
              <textarea
                className="w-full rounded-xl border-neutral-border text-sm focus:border-primary focus:ring-4 focus:ring-primary/10 placeholder:text-neutral-muted/50 resize-none h-full min-h-[250px] p-4 font-mono leading-relaxed bg-slate-50/30"
